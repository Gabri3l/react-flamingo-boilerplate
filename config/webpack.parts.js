...
/*
  ...
  In our case, here are all the fields employed:
    ...
    - rehydrateCss: serves a similar purpose, in this case we are setting a
      global variable named _emotion which allows us to simply rehydrate the css
      ...
      _emotion variables to whatever is passed in. This way when we call
      rehydrate in our code, the ids will be already set up.
